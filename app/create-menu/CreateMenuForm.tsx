...
import { createCustomMenu } from './actions'
...
export default function CreateMenuForm({ recipes }: Props) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
      <section className="rounded-2xl border bg-white p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-gray-900">Choose recipes</h2>
        <p className="mt-2 text-sm text-gray-600">
          Select between 1 and 7 recipes to build your custom weekly menu.
        </p>
      ...
      <section className="rounded-2xl border bg-white p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-gray-900">Your custom menu</h2>
        <p className="mt-2 text-sm text-gray-600">
          Add a name, optional short note, and review your selected recipes.
        </p>

        <form action={createCustomMenu} className="mt-5 space-y-5">
          <div>
            <label
              htmlFor="menuName"
            ...
            <input
              ...
              placeholder="For example: Quick Weeknight Dinners"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm outline-none focus:border-gray-500"
              placeholder="For example: Easy dinners for a busy week"
            />
          </div>
